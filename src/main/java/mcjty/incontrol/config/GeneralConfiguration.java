...
public class GeneralConfiguration {
    ...
    public static boolean FIRST_MATCH_ONLY = true;
    ...
    public static void init(Configuration cfg) {
        ...
        FIRST_MATCH_ONLY = cfg.getBoolean("firstMatchOnly", CATEGORY_GENERAL, FIRST_MATCH_ONLY, "Spawning rules only take actions/effects from the first entry that is matched correctly, this is default behavior, disable at own risk");
    }
